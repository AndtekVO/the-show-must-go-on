...
class InteractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post interactions_url, params: { interaction: { session_id: @interaction.session_id, source: @interaction.source, word: @interaction.word } }
    end
  ...
  test "should update interaction" do
    patch interaction_url(@interaction), params: { interaction: { session_id: @interaction.session_id, source: @interaction.source, word: @interaction.word } }
