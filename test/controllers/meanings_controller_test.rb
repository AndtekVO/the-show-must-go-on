...
class MeaningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meaning" do
    assert_difference('Meaning.count') do
      post meanings_url, params: { meaning: { creator: @meaning.creator, interaction_id: @meaning.interaction_id, meaning: @meaning.meaning } }
    end
  ...
  test "should update meaning" do
    patch meaning_url(@meaning), params: { meaning: { creator: @meaning.creator, interaction_id: @meaning.interaction_id, meaning: @meaning.meaning } }
